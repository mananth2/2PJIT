...
function[Wavenumber,GrowthRate,Cheb_coeff]=Cylindrical_3D_solution(Ujet,R,delta_l,delta_g,rhol,rhog,nul,nug,gamma,m_theta,omegaArray,H,Nl,Ng)
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%
